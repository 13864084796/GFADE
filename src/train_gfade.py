...
import sys
import random
from utils.gfade import GFADE_Dataset
...
def main(args):
    ...
    train_dataset=GFADE_Dataset(phase='train',image_size=image_size)
    val_dataset=GFADE_Dataset(phase='val',image_size=image_size)
